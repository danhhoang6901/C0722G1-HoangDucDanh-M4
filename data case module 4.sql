INSERT INTO case_study_module4.`position` ( `name`)
VALUES ( 'Lễ tân'),
( 'Phục vụ'),
( 'Chuyên viên'),
( 'Giám sát'),
( 'Quản lý'),
('Giám đốc');
INSERT INTO case_study_module4.`education_degree` ( `name`)
VALUES ( 'Trung Cấp'),
( 'Cao Đẳng'),
( 'Đại Học'),
( 'Sau Đại Học');
INSERT INTO case_study_module4.`division` ( `name`)
...
-- VALUES ('1', 'Admin'),
-- ('2', 'User');
INSERT INTO case_study_module4.`employee` ( `name`, `date_of_birth`, `id_card`, `salary`, `phone_number`, `email`, `address`, `position_id`, `education_degree_id`, `division_id`)
...
INSERT INTO case_study_module4.`customer_type` ( `name`)
VALUES ( 'Diamond'),
( 'Platinium'),
( 'Gold'),
( 'Silver'),
( 'Member');
INSERT INTO case_study_module4.`customer` ( `name`, `date_of_birth`,`gender`,`id_card`, `phone_number`, `email`, `address`, `customer_type_id`, `status`)
...
INSERT INTO case_study_module4.`facility_type` ( `name`) VALUES
( 'Villa'),
( 'House'),
('Room');
INSERT INTO case_study_module4.`rent_type` ( `name`)
VALUES ( 'year'),
( 'month'),
( 'day'),
( 'hour');
INSERT INTO case_study_module4.`facility` ( `name`, `area`, `cost`, `max_people`, `standard_room`, `description_other_convenience`, `pool_area`, `number_of_floors`, `facility_free`, `rent_type_id`, `facility_type_id`)
VALUES ( 'Villa Beach Front', 25000, 1000000, 10, 'vip', 'Có hồ bơi', 500, '4', null, 3, 1),
( 'House Princess 01', 14000, 5000000, 7, 'vip', 'Có thêm bếp nướng', 0, '3', null, 2, 2),
...
( 'House Princess 02', 10000, 4000000, 5, 'normal', 'Có thêm bếp nướng', 0, '2', null, 3, 2),
( 'Room Twin 02', 3000, 900000, 2, 'normal', 'Có tivi', 0, 0, '1 Xe máy', 4, 3);
INSERT INTO case_study_module4.`contract` ( `start_date`, `end_date`, `deposit`, `employee_id`, `customer_id`, `facility_id`)
...
INSERT INTO case_study_module4.`attach_facility` ( `name`, `cost`, `unit`, `status`)
...
INSERT INTO case_study_module4.`contract_detail`(`quantity`,`contract_id`,`attach_facility_id`)
VALUES(5,2,4),
(8,2,5),
(15,2,6),
(1,3,1),
